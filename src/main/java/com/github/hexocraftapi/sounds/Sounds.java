...
public enum Sounds
{
	...
	ENTITY_EXPERIENCE_ORB_TOUCH(Version.v1_9_R1, Version.v1_10_R1),		// Removed in 1.11
	...
	// List of Sounds introduced in 1.11
	BLOCK_SHULKER_BOX_CLOSE(Version.v1_11_R1, null),
	BLOCK_SHULKER_BOX_OPEN(Version.v1_11_R1, null),
	ENTITY_ELDER_GUARDIAN_FLOP(Version.v1_11_R1, null),
	ENTITY_EVOCATION_FANGS_ATTACK(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_AMBIENT(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_CAST_SPELL(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_DEATH(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_HURT(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_PREPARE_ATTACK(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_PREPARE_SUMMON(Version.v1_11_R1, null),
	ENTITY_EVOCATION_ILLAGER_PREPARE_WOLOLO(Version.v1_11_R1, null),
	ENTITY_LLAMA_AMBIENT(Version.v1_11_R1, null),
	ENTITY_LLAMA_ANGRY(Version.v1_11_R1, null),
	ENTITY_LLAMA_CHEST(Version.v1_11_R1, null),
	ENTITY_LLAMA_DEATH(Version.v1_11_R1, null),
	ENTITY_LLAMA_EAT(Version.v1_11_R1, null),
	ENTITY_LLAMA_HURT(Version.v1_11_R1, null),
	ENTITY_LLAMA_SPIT(Version.v1_11_R1, null),
	ENTITY_LLAMA_STEP(Version.v1_11_R1, null),
	ENTITY_LLAMA_SWAG(Version.v1_11_R1, null),
	ENTITY_MULE_CHEST(Version.v1_11_R1, null),
	ENTITY_VEX_AMBIENT(Version.v1_11_R1, null),
	ENTITY_VEX_CHARGE(Version.v1_11_R1, null),
	ENTITY_VEX_DEATH(Version.v1_11_R1, null),
	ENTITY_VEX_HURT(Version.v1_11_R1, null),
	ENTITY_VINDICATION_ILLAGER_AMBIENT(Version.v1_11_R1, null),
	ENTITY_VINDICATION_ILLAGER_DEATH(Version.v1_11_R1, null),
	ENTITY_VINDICATION_ILLAGER_HURT(Version.v1_11_R1, null),
	ITEM_ARMOR_EQUIP_ELYTRA(Version.v1_11_R1, null),
	ITEM_BOTTLE_EMPTY(Version.v1_11_R1, null),
	ITEM_TOTEM_USE(Version.v1_11_R1, null),

	// List of Sounds introduced in 1.12
	BLOCK_END_PORTAL_FRAME_FILL(Version.v1_12_R1, null),
	BLOCK_END_PORTAL_SPAWN(Version.v1_12_R1, null),
	BLOCK_NOTE_BELL(Version.v1_12_R1, null),
	BLOCK_NOTE_CHIME(Version.v1_12_R1, null),
	BLOCK_NOTE_FLUTE(Version.v1_12_R1, null),
	BLOCK_NOTE_GUITAR(Version.v1_12_R1, null),
	BLOCK_NOTE_XYLOPHONE(Version.v1_12_R1, null),
	ENTITY_BOAT_PADDLE_LAND(Version.v1_12_R1, null),
	ENTITY_BOAT_PADDLE_WATER(Version.v1_12_R1, null),
	ENTITY_BOBBER_RETRIEVE(Version.v1_12_R1, null),
	ENTITY_ENDEREYE_DEATH(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_AMBIENT(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_CAST_SPELL(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_DEATH(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_HURT(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_MIRROR_MOVE(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_PREPARE_BLINDNESS(Version.v1_12_R1, null),
	ENTITY_ILLUSION_ILLAGER_PREPARE_MIRROR(Version.v1_12_R1, null),
	ENTITY_PARROT_AMBIENT(Version.v1_12_R1, null),
	ENTITY_PARROT_DEATH(Version.v1_12_R1, null),
	ENTITY_PARROT_EAT(Version.v1_12_R1, null),
	ENTITY_PARROT_FLY(Version.v1_12_R1, null),
	ENTITY_PARROT_HURT(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_BLAZE(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_CREEPER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ELDER_GUARDIAN(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ENDERDRAGON(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ENDERMAN(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ENDERMITE(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_EVOCATION_ILLAGER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_GHAST(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_HUSK(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ILLUSION_ILLAGER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_MAGMACUBE(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_POLAR_BEAR(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_SHULKER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_SILVERFISH(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_SKELETON(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_SLIME(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_SPIDER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_STRAY(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_VEX(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_VINDICATION_ILLAGER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_WITCH(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_WITHER(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_WITHER_SKELETON(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_WOLF(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ZOMBIE(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ZOMBIE_PIGMAN(Version.v1_12_R1, null),
	ENTITY_PARROT_IMITATE_ZOMBIE_VILLAGER(Version.v1_12_R1, null),
	ENTITY_PARROT_STEP(Version.v1_12_R1, null),
	ENTITY_PLAYER_HURT_DROWN(Version.v1_12_R1, null),
	ENTITY_PLAYER_HURT_ON_FIRE(Version.v1_12_R1, null);
